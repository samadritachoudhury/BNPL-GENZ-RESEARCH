...
The model explained 39% of variance in usage intention (R² = 0.39).

## Methodology
- n = 103 Gen Z respondents, surveyed via Google Forms
- SERVQUAL-inspired 9-item scale to measure perceived BNPL service quality
- SPSS: descriptive statistics, Pearson correlation, multiple regression
- Cronbach's Alpha = 0.896 (high internal consistency)

## Limitations I'd fix in a follow-up
Convenience sampling limits generalisability. I'd use stratified 
sampling across income groups in a future study, and replace proxy 
intention measures with validated purchase intention scales.

---
Samadrita Choudhury | BBA FinTech & Business Analytics | SMIT | 2026
